...
#define sx126x_transfer_cmd(drv, opCode, data, nData) sx126x_transfer(drv, opCode, data, nData, NULL, 0, true)

#ifndef SX126X_RET_TYPE
#define SX126X_RET_TYPE uint8_t
#endif
...
void sx126x_setRfFrequency(sx126x_driver_t *sx126x_drv, uint32_t rfFrequency);
